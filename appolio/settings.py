"""
Django settings for appolio project.
...
SECRET_KEY = 'django-insecure-9scw&fkbv%=u%mcw6fg3i8l&x!@azc!yyeqh(9a(2w8yzb+!@9'
...
MIDDLEWARE = [
    ...
    'appolio.middleware.RequestLoggingMiddleware'
]

ROOT_URLCONF = 'appolio.urls'
...
WSGI_APPLICATION = 'appolio.wsgi.application'
