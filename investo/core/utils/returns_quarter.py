...
def calculated_quarterly_return_compound(start_amount, start_day, start_month, start_year, cal_day, cal_month, cal_year, interest_rate):
    """
...
def calculated_quarterly_return_non_compound(start_amount, start_day, start_month, start_year, cal_day, cal_month, cal_year, interest_rate):
    """
    Calculate the quarterly returns for the given account
    """
