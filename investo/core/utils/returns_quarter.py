...
def calculated_quarterly_return_compound(start_amount, start_day, start_month, start_year, cal_day, cal_month, cal_year,
                                         interest_rate):
    """
    ...
    logger.debug("Calc Date")
    logger.debug(cal_date)
    logger.debug("Total Diff Days")
    logger.debug(total_diff_days)

    current_year_th = total_diff_days // 365
    prev_year_diff = current_year_th - 1 if current_year_th > 0 else 0

    logger.debug("Current Year th")
    logger.debug(current_year_th)
    logger.debug("Prev Year th")
    logger.debug(prev_year_diff)
...
def calculated_quarterly_return_non_compound(start_amount, start_day, start_month, start_year, cal_day, cal_month,
